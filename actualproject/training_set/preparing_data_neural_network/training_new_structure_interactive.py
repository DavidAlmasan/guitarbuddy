...
W1 = tf.Variable(tf.truncated_normal([1023, 500], stddev = 0.1)) #500 neurons
b1 = tf.Variable(tf.zeros([500]))
W2 = tf.Variable(tf.truncated_normal([500, 100], stddev = 0.1)) #100 neurons
b2 = tf.Variable(tf.zeros([100]))
W3 = tf.Variable(tf.truncated_normal([100, 50], stddev = 0.1)) #50 neurons
b3 = tf.Variable(tf.zeros([50]))
W4 = tf.Variable(tf.truncated_normal([50, 10], stddev = 0.1)) #10 neurons
b4 = tf.Variable(tf.zeros([10]))
W5 = tf.Variable(tf.truncated_normal([10, 2], stddev = 0.1))
